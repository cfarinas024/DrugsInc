      ...
      <div className = "img">
        ...
        <div className = "container">
          <div className = "row">
            ...
            <div className = "col-md-4">
              <h2>Donate</h2>
              <p>We accept donations from sponsors. By donating medicines you are helping
                 a lot of people. Donate now! Just click on the link below and fill up the form.</p>
              <Link to='/donate' className='buton btn btn-default'>Donate »</Link>
            </div>

            <div className = "col-md-4">
              <h2>Request</h2>
              <p>Request medicines you need now to acquire them as soon as possible.
                 Click the link below and fill up the Request Form.</p>
